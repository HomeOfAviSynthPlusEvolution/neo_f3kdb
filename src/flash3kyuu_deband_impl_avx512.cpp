#if defined(HAS_AVX512) && (defined(__x86_64__) || defined(_M_X64) || defined(__i386) || defined(_M_IX86))

#include <immintrin.h>
#include "flash3kyuu_deband_avx_base.h"

#define INSTANTIATE_IMPL(mode, blur, dither) \
    template void ns_avx512::process_plane_impl<mode, blur, dither>( \
